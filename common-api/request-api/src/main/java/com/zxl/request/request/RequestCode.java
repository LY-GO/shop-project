...
public enum RequestCode {
    ...
    SERVICE_ERROR(40001, "service error", "错误"),
    CONTROLLER_ERROR(40006, "controller error", "获取token错误"),
    // 用户相关
    UN_LOGIN(40001, "no login", "未登录"),
    UN_AUTH(40003, "no auth  account", "未授权"),
    //消息队列
    MQ_ERROR(40004, "consumer error", "消息接收失败"),
    /*用户未登录*/
    ...
    RequestCode(int status, String msg, String tips) {
        this.status = status;
        this.msg = msg;
        this.tips = tips;
    }
